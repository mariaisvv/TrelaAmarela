...
namespace Trela_Amarela.Areas.Identity.Pages.Account {
   [AllowAnonymous]
         ...
         if (ModelState.IsValid) {
            ...
            if (result.Succeeded) {
               _logger.LogInformation("User created a new account with password.");
                    ...
                    Input.Cliente.Email = Input.Email; // atribuir ao objeto 'cliente' o email fornecido pelo utilizador,
                                                  // a quando da escrita dos dados na interface
